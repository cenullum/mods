...
-- =============================================================================
-- Operation: Detonate - player entity.
--
-- There are no walking avatars: everyone sits around one table (the camera is
-- rotated per seat by od_manager). The only per-player world presence is the
...
local cursor_name = "od_cur_" .. name
...
local function my_color()
    local colors = get_value("", "-od_manager", "cl_colors")

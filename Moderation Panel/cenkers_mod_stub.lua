...
-- 1. VELOCITY CAP: Entity velocity is capped at 300. Values above this are unnecessary.
...
--- NOTE: Velocity magnitude is capped at 300 by the engine.
---@type Vector2
...
--- WARNING: Singletons created via spawn_entity_host/local will NOT work! Must be spawned from map.
--- Default: ""
---@type string
singleton_name = ""

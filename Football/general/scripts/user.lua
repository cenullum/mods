...
function hit_ball()
    if IS_HOST and is_ball_interactable then
        ...
        new_vel = way * 3.0 *
        hit_value                                                   -- Linear velocity magnitude is capped at 300 for all objects; values above are unnecessary.  3.0 multiply 100 (max value of hit_value) is 300
